...
function drawBuildings () {
  ...
  while(i < 6) {
    let building = Rectangle(Vector(buildingX, buildingY), 150, 400, true, '#95a5a6', true, '#7f8c8d', 3, ctx);
  ...
  while(iWindows < 292) {
    let window   = Rectangle(Vector(windowX, windowY  + 20), 20, 20, true, windowColor, true, '#000', 2, ctx);
    windowX = windowX + 30;
    window.update();
    windows.push(window);
    iWindows++;
